...
public class GenericArrayList<T> implements IGenericList<T> {
    /**
    ...
    /** This will change as buffer fills up and as we allocate more and more storage space */
    ...
    public GenericArrayList(){
        ...
        nextFreeLoc = 0;
        //buffer = new Object[currentCapacity];
